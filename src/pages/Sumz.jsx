...
const Sumz = () => {
  ...
  <path fill-rule="evenodd" d="M9.53 2.47a.75.75 0 010 1.06L4.81 8.25H15a6.75 6.75 0 010 13.5h-3a.75.75 0 010-1.5h3a5.25 5.25 0 100-10.5H4.81l4.72 4.72a.75.75 0 11-1.06 1.06l-6-6a.75.75 0 010-1.06l6-6a.75.75 0 011.06 0z" clip-rule="evenodd" />
        ...
        {/* {loading === false ? <div className='h-[200px] md:h-[400px]'><div>
        <button type="button">
    <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        </div></div> : <div className='py-5 px-5 h-max bg-gradient-to-r from-pink-300 via-purple-300 to-indigo-400 rounded-md w-[300px] md:w-[600px] mx-auto'>
        {apiData}
        </div>} */}
        {loading && (
      ...
      {!loading && apiData && (
        ...
        {apiData === null ? <div className='h-[200px] md:h-[400px]'>
</div> : <span></span>
        }
